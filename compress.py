...
class CompressionNet:
    def __init__(self, target_dim=512):
        if target_dim == 512:
            self.saved_model_dir = "network/compression_network_768_to_512_261452epochs_3Layer1024.pb"
            self.max_file = "network/compression_network_768_to_512_261452epochs_3Layer1024_max.npy"
            self.min_file = "network/compression_network_768_to_512_261452epochs_3Layer1024_min.npy"
